...
public class DeviceSession {
 ...
 private String deviceVariant = "UNKNOWN";
 ...
 public DeviceSession(IMEI imei, Channel channel) {
     ...
     this.remoteAddress = channel != null && channel.remoteAddress() != null ? 
 ...
 public String toString() {
     return String.format("DeviceSession{id='%s', imei=%s, authenticated=%s, channelId='%s', remoteAddress='%s', variant='%s'}",
